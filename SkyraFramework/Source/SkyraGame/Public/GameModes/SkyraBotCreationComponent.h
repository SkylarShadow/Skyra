...
#include "SkyraBotCreationComponent.generated.h"
...
class USkyraBotCreationComponent : public UGameStateComponent
{
	GENERATED_BODY()

public:
	USkyraBotCreationComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
