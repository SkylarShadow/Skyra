...
#include "SkyraUserFacingExperienceDefinition.generated.h"
...
class USkyraUserFacingExperienceDefinition : public UPrimaryDataAsset
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category=Experience, meta=(AllowedTypes="SkyraExperienceDefinition"))
