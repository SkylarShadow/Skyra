 ...
 */
DECLARE_MULTICAST_DELEGATE_TwoParams(FOnSkyraGameModePlayerInitialized, AGameModeBase* /*GameMode*/, AController* /*NewPlayer*/);
...
class ASkyraGameMode : public AModularGameModeBase
{
	GENERATED_BODY()
...
public:
	...
	FOnSkyraGameModePlayerInitialized OnGameModePlayerInitialized;
