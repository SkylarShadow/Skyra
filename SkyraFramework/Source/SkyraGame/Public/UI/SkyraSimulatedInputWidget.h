...
#include "SkyraSimulatedInputWidget.generated.h"

#define UE_API SKYRAGAME_API
 ...
 */
UCLASS(MinimalAPI, meta=( DisplayName="Skyra Simulated Input Widget" ))
class USkyraSimulatedInputWidget : public UCommonUserWidget
{
	GENERATED_BODY()
	
public:
	
	UE_API USkyraSimulatedInputWidget(const FObjectInitializer& ObjectInitializer);
