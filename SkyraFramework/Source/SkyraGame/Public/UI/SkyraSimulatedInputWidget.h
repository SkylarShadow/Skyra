 ...
 */
UCLASS(meta=( DisplayName="Skyra Simulated Input Widget" ))
class SKYRAGAME_API USkyraSimulatedInputWidget : public UCommonUserWidget
{
	GENERATED_BODY()
	
public:
	
	USkyraSimulatedInputWidget(const FObjectInitializer& ObjectInitializer);
