...
#include "SkyraSettingScreen.generated.h"

class UGameSettingRegistry;
class USkyraTabListWidgetBase;
class UObject;

UCLASS(Abstract, meta = (Category = "Settings", DisableNativeTick))
class USkyraSettingScreen : public UGameSettingScreen
{
	GENERATED_BODY()
...
protected:
	...
	TObjectPtr<USkyraTabListWidgetBase> TopSettingsTabs;
