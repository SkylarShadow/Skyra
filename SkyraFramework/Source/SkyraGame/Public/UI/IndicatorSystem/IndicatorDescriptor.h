...
class SKYRAGAME_API UIndicatorDescriptor : public UObject
{
	GENERATED_BODY()
...
public:
	USkyraIndicatorManagerComponent* GetIndicatorManagerComponent() { return ManagerPtr.Get(); }
	void SetIndicatorManagerComponent(USkyraIndicatorManagerComponent* InManager);
...
private:
	...
	UPROPERTY()
	TWeakObjectPtr<USkyraIndicatorManagerComponent> ManagerPtr;
