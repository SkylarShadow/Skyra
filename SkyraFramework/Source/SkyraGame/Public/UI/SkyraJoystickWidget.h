...
#include "SkyraJoystickWidget.generated.h"
...
/**
 *  A UMG wrapper for the skyra virtual joystick.
 *
 ...
 */
UCLASS(meta=( DisplayName="Skyra Joystick" ))
class SKYRAGAME_API USkyraJoystickWidget : public USkyraSimulatedInputWidget
{
	GENERATED_BODY()
	
public:
	
	USkyraJoystickWidget(const FObjectInitializer& ObjectInitializer);
