...
#include "SkyraFrontendStateComponent.generated.h"
...
UCLASS(Abstract)
class USkyraFrontendStateComponent : public UGameStateComponent, public ILoadingProcessInterface
{
	GENERATED_BODY()

public:

	USkyraFrontendStateComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
