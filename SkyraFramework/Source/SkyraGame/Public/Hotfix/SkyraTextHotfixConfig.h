...
#include "SkyraTextHotfixConfig.generated.h"
...
class USkyraTextHotfixConfig : public UDeveloperSettings
{
	GENERATED_BODY()

public:
	USkyraTextHotfixConfig(const FObjectInitializer& ObjectInitializer);
