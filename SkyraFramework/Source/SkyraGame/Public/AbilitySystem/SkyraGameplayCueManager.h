...
#include "SkyraGameplayCueManager.generated.h"
...
/**
 * USkyraGameplayCueManager
 *
 * Game-specific manager for gameplay cues
 */
UCLASS()
class USkyraGameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()

public:
	USkyraGameplayCueManager(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	static USkyraGameplayCueManager* Get();
