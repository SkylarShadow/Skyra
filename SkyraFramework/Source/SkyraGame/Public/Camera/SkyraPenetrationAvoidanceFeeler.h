...
#include "SkyraPenetrationAvoidanceFeeler.generated.h"

/**
 * Struct defining a feeler ray used for camera penetration avoidance.
 */
USTRUCT()
struct FSkyraPenetrationAvoidanceFeeler
{
	GENERATED_BODY()
	...
	FSkyraPenetrationAvoidanceFeeler()
	...
	FSkyraPenetrationAvoidanceFeeler(const FRotator& InAdjustmentRot,
