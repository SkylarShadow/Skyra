...
#include "SkyraPenetrationAvoidanceFeeler.h"
#include "DrawDebugHelpers.h"
#include "SkyraCameraMode_ThirdPerson.generated.h"

class UCurveVector;

/**
 * USkyraCameraMode_ThirdPerson
 *
 *	A basic third person camera mode.
 */
UCLASS(Abstract, Blueprintable)
class USkyraCameraMode_ThirdPerson : public USkyraCameraMode
{
	GENERATED_BODY()
...
public:
	...
	TArray<FSkyraPenetrationAvoidanceFeeler> PenetrationAvoidanceFeelers;
