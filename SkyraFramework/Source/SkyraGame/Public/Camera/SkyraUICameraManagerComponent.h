...
#include "SkyraUICameraManagerComponent.generated.h"

class ASkyraPlayerCameraManager;
...
UCLASS( Transient, Within=SkyraPlayerCameraManager )
class USkyraUICameraManagerComponent : public UActorComponent
{
	GENERATED_BODY()

public:
	static USkyraUICameraManagerComponent* GetComponent(APlayerController* PC);

public:
	USkyraUICameraManagerComponent();	
