...
#include "SkyraCharacterPartTypes.generated.h"
...
struct FSkyraCharacterPartHandle
{
	GENERATED_BODY()
...
struct FSkyraCharacterPart
{
	...
	static bool AreEquivalentParts(const FSkyraCharacterPart& A, const FSkyraCharacterPart& B)
	{
