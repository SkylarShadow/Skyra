...
#include "SkyraCosmeticAnimationTypes.generated.h"
...
struct FSkyraAnimLayerSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct SKYRAGAME_API FSkyraAnimLayerSelectionSet
{
	GENERATED_BODY()
	...
	TArray<FSkyraAnimLayerSelectionEntry> LayerRules;
...
USTRUCT(BlueprintType)
struct FSkyraAnimBodyStyleSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct SKYRAGAME_API FSkyraAnimBodyStyleSelectionSet
{
	GENERATED_BODY()
		
	// List of layer rules to apply, first one that matches will be used
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta=(TitleProperty=Mesh))
	TArray<FSkyraAnimBodyStyleSelectionEntry> MeshRules;
