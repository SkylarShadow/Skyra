...
#include "SkyraSafeZoneEditor.generated.h"
...
UCLASS(Abstract)
class USkyraSafeZoneEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	USkyraSafeZoneEditor(const FObjectInitializer& Initializer);
