...
#include "SkyraBrightnessEditor.generated.h"
...
UCLASS(Abstract)
class USkyraBrightnessEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	USkyraBrightnessEditor(const FObjectInitializer& Initializer);
