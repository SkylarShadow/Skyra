...
#include "SkyraSettingValueDiscreteDynamic_AudioOutputDevice.generated.h"
...
UCLASS()
class USkyraSettingValueDiscreteDynamic_AudioOutputDevice : public UGameSettingValueDiscreteDynamic
{
	GENERATED_BODY()
	
public:

	virtual ~USkyraSettingValueDiscreteDynamic_AudioOutputDevice() = default;
