...
#include "SkyraSettingValueDiscrete_Resolution.generated.h"
...
UCLASS()
class USkyraSettingValueDiscrete_Resolution : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	USkyraSettingValueDiscrete_Resolution();
