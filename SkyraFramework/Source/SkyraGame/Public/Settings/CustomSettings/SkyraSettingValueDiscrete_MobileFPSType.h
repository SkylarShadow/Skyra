...
//#include "Settings/SkyraMobilePerformance.h"
#include "GameSettingValueDiscrete.h"

#include "SkyraSettingValueDiscrete_MobileFPSType.generated.h"
...
UCLASS()
class USkyraSettingValueDiscrete_MobileFPSType : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	USkyraSettingValueDiscrete_MobileFPSType();
