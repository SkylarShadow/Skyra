...
public:
	...
	TObjectPtr<USkyraInventoryItemInstance> Item = nullptr;
};
...
public:
	...
	static void AddPickupToInventory(USkyraInventoryManagerComponent* InventoryComponent, TScriptInterface<IPickupable> Pickup);
};
