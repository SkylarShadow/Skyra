...
#include "Camera/SkyraCameraAssistInterface.h"
#include "CommonPlayerController.h"
#include "Teams/SkyraTeamAgentInterface.h"

#include "SkyraPlayerController.generated.h"
...
class SKYRAGAME_API ASkyraPlayerController : public ACommonPlayerController, public ISkyraCameraAssistInterface, public ISkyraTeamAgentInterface
{
	GENERATED_BODY()

public:

	ASkyraPlayerController(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	UFUNCTION(BlueprintCallable, Category = "Skyra|PlayerController")
	ASkyraPlayerState* GetSkyraPlayerState() const;

	UFUNCTION(BlueprintCallable, Category = "Skyra|PlayerController")
	USkyraAbilitySystemComponent* GetSkyraAbilitySystemComponent() const;

	UFUNCTION(BlueprintCallable, Category = "Skyra|PlayerController")
	ASkyraHUD* GetSkyraHUD() const;
	...
	//~ISkyraCameraAssistInterface interface
	virtual void OnCameraPenetratingTarget() override;
	//~End of ISkyraCameraAssistInterface interface
...
protected:
	...
	void OnSettingsChanged(USkyraSettingsShared* Settings);
...
UCLASS()
class ASkyraReplayPlayerController : public ASkyraPlayerController
{
	GENERATED_BODY()
