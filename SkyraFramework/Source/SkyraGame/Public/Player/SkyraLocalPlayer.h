...
#include "SkyraLocalPlayer.generated.h"

struct FGenericTeamId;

class APlayerController;
class UInputMappingContext;
class USkyraSettingsLocal;
 ...
 */
UCLASS()
class SKYRAGAME_API USkyraLocalPlayer : public UCommonLocalPlayer, public ISkyraTeamAgentInterface
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION()
	USkyraSettingsLocal* GetLocalSettings() const;

	/** Gets the shared setting for this player, this is read using the save game system so may not be correct until after user login */
	UFUNCTION()
	USkyraSettingsShared* GetSharedSettings() const;
...
protected:
	void OnSharedSettingsLoaded(USkyraSettingsShared* LoadedOrCreatedSettings);
...
private:
	UPROPERTY(Transient)
	mutable TObjectPtr<USkyraSettingsShared> SharedSettings;
