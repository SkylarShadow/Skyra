...
#include "SkyraCheatManager.generated.h"
...
DECLARE_LOG_CATEGORY_EXTERN(LogSkyraCheat, Log, All);
...
class USkyraCheatManager : public UCheatManager
{
	GENERATED_BODY()
...
protected:
	...
	void ApplySetByCallerDamage(USkyraAbilitySystemComponent* SkyraASC, float DamageAmount);
	void ApplySetByCallerHeal(USkyraAbilitySystemComponent* SkyraASC, float HealAmount);

	USkyraAbilitySystemComponent* GetPlayerAbilitySystemComponent() const;
};
