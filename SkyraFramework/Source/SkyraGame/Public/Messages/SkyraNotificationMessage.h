...
#include "SkyraNotificationMessage.generated.h"

class UObject;

SKYRAGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Skyra_AddNotification_Message);

class APlayerState;

// A message destined for a transient log (e.g., an elimination feed or inventory pickup stream)
USTRUCT(BlueprintType)
struct SKYRAGAME_API FSkyraNotificationMessage
{
	GENERATED_BODY()
