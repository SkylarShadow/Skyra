...
#include "SkyraPlayerInput.generated.h"

/**
 * Custom player input class for Skyra. This extends the functionality of Enhanced Input to also include
...
class USkyraPlayerInput : public UEnhancedPlayerInput
{
    GENERATED_BODY()

public:
    USkyraPlayerInput();
    virtual ~USkyraPlayerInput() override;
