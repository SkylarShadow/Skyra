...
#include "SkyraInputUserSettings.generated.h"

/** 
 * Custom settings class for any input related settings for the Skyra game.
 * This will be serialized out at the same time as the Skyra Shared Settings and is
 * compatible with cloud saves through by calling the "Serialize" function.
 */
UCLASS()
class SKYRAGAME_API USkyraInputUserSettings : public UEnhancedInputUserSettings
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS()
class SKYRAGAME_API USkyraPlayerMappableKeySettings : public UPlayerMappableKeySettings
{
	GENERATED_BODY()
