...
#include "SkyraContextEffectsInterface.generated.h"
 ...
 */
 ...
 class SKYRAGAME_API USkyraContextEffectsInterface : public UInterface
 {
	 GENERATED_BODY()

 };
 
 class SKYRAGAME_API ISkyraContextEffectsInterface : public IInterface
 {
	 GENERATED_BODY()
