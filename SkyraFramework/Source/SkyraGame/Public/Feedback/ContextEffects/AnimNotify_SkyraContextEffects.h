...
#include "AnimNotify_SkyraContextEffects.generated.h"

/**
 *
 */
USTRUCT(BlueprintType)
struct SKYRAGAME_API FSkyraContextEffectAnimNotifyVFXSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct SKYRAGAME_API FSkyraContextEffectAnimNotifyAudioSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct SKYRAGAME_API FSkyraContextEffectAnimNotifyTraceSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct SKYRAGAME_API FSkyraContextEffectAnimNotifyPreviewSettings
{
	GENERATED_BODY()
	...
	// Preview Library
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Preview, meta = (AllowedClasses = "/Script/SkyraGame.SkyraContextEffectsLibrary"))
...
class SKYRAGAME_API UAnimNotify_SkyraContextEffects : public UAnimNotify
{
	GENERATED_BODY()

public:
	UAnimNotify_SkyraContextEffects();
	...
	// Scale to spawn the particle system at
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AnimNotify", meta = (ExposeOnSpawn = true))
	FSkyraContextEffectAnimNotifyVFXSettings VFXProperties;

	// Scale to spawn the particle system at
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AnimNotify", meta = (ExposeOnSpawn = true))
	FSkyraContextEffectAnimNotifyAudioSettings AudioProperties;
	...
	FSkyraContextEffectAnimNotifyTraceSettings TraceProperties;
	...
	FSkyraContextEffectAnimNotifyPreviewSettings PreviewProperties;
#endif
