...
#include "SkyraContextEffectComponent.generated.h"
...
class SKYRAGAME_API USkyraContextEffectComponent : public UActorComponent, public ISkyraContextEffectsInterface
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditAnywhere)
	TSet<TSoftObjectPtr<USkyraContextEffectsLibrary>> DefaultContextEffectsLibraries;

	UFUNCTION(BlueprintCallable)
	void UpdateEffectContexts(FGameplayTagContainer NewEffectContexts);

	UFUNCTION(BlueprintCallable)
	void UpdateLibraries(TSet<TSoftObjectPtr<USkyraContextEffectsLibrary>> NewContextEffectsLibraries);
...
private:
	...
	UPROPERTY(Transient)
	TSet<TSoftObjectPtr<USkyraContextEffectsLibrary>> CurrentContextEffectsLibraries;
