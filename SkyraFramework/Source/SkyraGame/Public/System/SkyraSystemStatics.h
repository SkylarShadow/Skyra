...
#include "SkyraSystemStatics.generated.h"
...
UCLASS()
class USkyraSystemStatics : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category="Skyra", meta = (WorldContext = "WorldContextObject"))
