...
#include "SkyraGameFeaturePolicy.generated.h"
...
class USkyraGameFeaturePolicy : public UDefaultGameFeaturesProjectPolicies
{
	GENERATED_BODY()

public:
	SKYRAGAME_API static USkyraGameFeaturePolicy& Get();

	USkyraGameFeaturePolicy(const FObjectInitializer& ObjectInitializer);
...
// checked
UCLASS()
class USkyraGameFeature_HotfixManager : public UObject, public IGameFeatureStateChangeObserver
{
	GENERATED_BODY()
...
// checked
UCLASS()
class USkyraGameFeature_AddGameplayCuePaths : public UObject, public IGameFeatureStateChangeObserver
{
	GENERATED_BODY()
