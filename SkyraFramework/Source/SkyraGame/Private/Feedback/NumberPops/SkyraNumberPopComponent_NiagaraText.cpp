...
#include "SkyraNumberPopComponent_NiagaraText.h"

#include "Feedback/NumberPops/SkyraNumberPopComponent.h"
#include "SkyraDamagePopStyleNiagara.h"
#include "SkyraLogChannels.h"
#include "NiagaraComponent.h"
#include "NiagaraDataInterfaceArrayFunctionLibrary.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(SkyraNumberPopComponent_NiagaraText)

USkyraNumberPopComponent_NiagaraText::USkyraNumberPopComponent_NiagaraText(const FObjectInitializer& ObjectInitializer)
...
void USkyraNumberPopComponent_NiagaraText::AddNumberPop(const FSkyraNumberPopRequest& NewRequest)
{
	...
	UE_LOG(LogSkyra, Log, TEXT("DamageHit location : %s"), *(NewRequest.WorldLocation.ToString()));
