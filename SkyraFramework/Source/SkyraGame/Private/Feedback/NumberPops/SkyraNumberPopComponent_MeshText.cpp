...
#include "SkyraNumberPopComponent_MeshText.h"

#include "Components/StaticMeshComponent.h"
#include "Engine/CollisionProfile.h"
#include "Engine/Engine.h"
#include "Engine/World.h"
#include "Feedback/NumberPops/SkyraNumberPopComponent.h"
#include "SkyraDamagePopStyle.h"
#include "Materials/MaterialInstanceDynamic.h"
#include "TimerManager.h"
#include "UObject/Package.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(SkyraNumberPopComponent_MeshText)

class UStaticMesh;

USkyraNumberPopComponent_MeshText::USkyraNumberPopComponent_MeshText(const FObjectInitializer& ObjectInitializer)
...
void USkyraNumberPopComponent_MeshText::AddNumberPop(const FSkyraNumberPopRequest& NewRequest)
{
...
void USkyraNumberPopComponent_MeshText::ReleaseNextComponents()
{
	UWorld* LocalWorld = GetWorld();
	check(LocalWorld);
...
FLinearColor USkyraNumberPopComponent_MeshText::DetermineColor(const FSkyraNumberPopRequest& Request) const
{
	for (USkyraDamagePopStyle* Style : Styles)
	{
...
UStaticMesh* USkyraNumberPopComponent_MeshText::DetermineStaticMesh(const FSkyraNumberPopRequest& Request) const
{
	for (USkyraDamagePopStyle* Style : Styles)
	{
...
void USkyraNumberPopComponent_MeshText::SetMaterialParameters(const FSkyraNumberPopRequest& Request, FTempNumberPopInfo& NewDamageNumberInfo, const FTransform& CameraTransform, const FVector& NumberLocation)
{
