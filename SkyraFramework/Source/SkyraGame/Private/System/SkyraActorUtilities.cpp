...
#include "SkyraActorUtilities.h"

#include "GameFramework/Actor.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(SkyraActorUtilities)

EBlueprintExposedNetMode USkyraActorUtilities::SwitchOnNetMode(const UObject* WorldContextObject)
{
