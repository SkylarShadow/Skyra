...
#include "SkyraTaggedWidget.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(SkyraTaggedWidget)

//@TODO: The other TODOs in this file are all related to tag-based showing/hiding of widgets, see UE-142237

USkyraTaggedWidget::USkyraTaggedWidget(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

void USkyraTaggedWidget::NativeConstruct()
{
...
void USkyraTaggedWidget::NativeDestruct()
{
	if (!IsDesignTime())
	{
...
void USkyraTaggedWidget::SetVisibility(ESlateVisibility InVisibility)
{
...
void USkyraTaggedWidget::OnWatchedTagsChanged()
{
	const bool bHasHiddenTags = false;//@TODO: Foo->HasAnyTags(HiddenByTags);
