...
void UIndicatorDescriptor::SetIndicatorManagerComponent(USkyraIndicatorManagerComponent* InManager)
{
...
{
	if (USkyraIndicatorManagerComponent* Manager = ManagerPtr.Get())
	{
