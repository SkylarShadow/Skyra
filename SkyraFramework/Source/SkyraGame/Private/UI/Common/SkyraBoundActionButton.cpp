...
#include "SkyraBoundActionButton.h"

#include "CommonInputSubsystem.h"
#include "CommonInputTypeEnum.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(SkyraBoundActionButton)

class UCommonButtonStyle;

void USkyraBoundActionButton::NativeConstruct()
{
...
void USkyraBoundActionButton::HandleInputMethodChanged(ECommonInputType NewInputMethod)
{
