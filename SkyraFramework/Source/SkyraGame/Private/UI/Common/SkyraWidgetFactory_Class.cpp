...
#include "SkyraWidgetFactory_Class.h"

#include "Blueprint/UserWidget.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(SkyraWidgetFactory_Class)

TSubclassOf<UUserWidget> USkyraWidgetFactory_Class::FindWidgetClassForData_Implementation(const UObject* Data) const
{
