...
#include "SkyraControllerDisconnectedScreen.h"

#include "Components/HorizontalBox.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(SkyraControllerDisconnectedScreen)

void USkyraControllerDisconnectedScreen::NativeOnActivated()
{
