...
#include UE_INLINE_GENERATED_CPP_BY_NAME(SkyraHotfixManager)

int32 USkyraHotfixManager::GameHotfixCounter = 0;

USkyraHotfixManager::USkyraHotfixManager()
{
#if !UE_BUILD_SHIPPING
	OnScreenMessageHandle = FCoreDelegates::OnGetOnScreenMessages.AddUObject(this, &USkyraHotfixManager::GetOnScreenMessages);
...
void USkyraHotfixManager::Init()
{
	Super::Init();
}

void USkyraHotfixManager::OnHotfixCompleted(EHotfixResult HotfixResult)
{
	...
	if (bHasPendingDeviceProfileHotfix)
	{
		...
		USkyraSettingsLocal* GameSettings = USkyraSettingsLocal::Get();
...
bool USkyraHotfixManager::WantsHotfixProcessing(const FCloudFileHeader& FileHeader)
{
...
bool USkyraHotfixManager::HotfixIniFile(const FString& FileName, const FString& IniData)
{
...
bool USkyraHotfixManager::ApplyHotfixProcessing(const FCloudFileHeader& FileHeader)
{
...
bool USkyraHotfixManager::ShouldWarnAboutMissingWhenPatchingFromIni(const FString& AssetPath) const
{
	return AssetPath.StartsWith(TEXT("/Engine/")) || AssetPath.StartsWith(TEXT("/Game/"));
}

void USkyraHotfixManager::PatchAssetsFromIniFiles()
{
#if ENABLE_SHARED_MEMORY_TRACKER
...
void USkyraHotfixManager::OnHotfixAvailablityCheck(const TArray<FCloudFileHeader>& PendingChangedFiles, const TArray<FCloudFileHeader>& PendingRemoveFiles)
{
...
#if !UE_BUILD_SHIPPING
void USkyraHotfixManager::GetOnScreenMessages(TMultiMap<FCoreDelegates::EOnScreenMessageSeverity, FText>& OutMessages)
{
	// TODO Any messages/errors.
}
#endif // !UE_BUILD_SHIPPING

void USkyraHotfixManager::RequestPatchAssetsFromIniFiles()
{
...
void USkyraHotfixManager::StartHotfixProcess()
{
	if (GIsEditor)
	{
