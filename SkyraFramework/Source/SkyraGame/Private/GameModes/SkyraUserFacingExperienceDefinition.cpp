...
#include "SkyraUserFacingExperienceDefinition.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(SkyraUserFacingExperienceDefinition)

UCommonSession_HostSessionRequest* USkyraUserFacingExperienceDefinition::CreateHostingRequest(const UObject* WorldContextObject) const
{
	...
	if (USkyraReplaySubsystem::DoesPlatformSupportReplays())
	{
		if (bRecordReplay)
		{
