...
#include "SkyraPlatformEmulationSettings.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(SkyraPlatformEmulationSettings)

#define LOCTEXT_NAMESPACE "SkyraCheats"

USkyraPlatformEmulationSettings::USkyraPlatformEmulationSettings()
{
}

FName USkyraPlatformEmulationSettings::GetCategoryName() const
{
	return FApp::GetProjectName();
}

FName USkyraPlatformEmulationSettings::GetPretendBaseDeviceProfile() const
{
	return PretendBaseDeviceProfile;
}

FName USkyraPlatformEmulationSettings::GetPretendPlatformName() const
{
	return PretendPlatform;
}

#if WITH_EDITOR
void USkyraPlatformEmulationSettings::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void USkyraPlatformEmulationSettings::PostReloadConfig(FProperty* PropertyThatWasLoaded)
{
...
void USkyraPlatformEmulationSettings::PostInitProperties()
{
...
void USkyraPlatformEmulationSettings::OnPlayInEditorStarted() const
{
...
void USkyraPlatformEmulationSettings::ApplySettings()
{
...
void USkyraPlatformEmulationSettings::ChangeActivePretendPlatform(FName NewPlatformName)
{
...
TArray<FName> USkyraPlatformEmulationSettings::GetKnownPlatformIds() const
{
...
TArray<FName> USkyraPlatformEmulationSettings::GetKnownDeviceProfiles() const
{
	TArray<FName> Results;
...
void USkyraPlatformEmulationSettings::PickReasonableBaseDeviceProfile()
{
