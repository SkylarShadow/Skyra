...
#include "SkyraSettingValueDiscrete_Resolution.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(SkyraSettingValueDiscrete_Resolution)

#define LOCTEXT_NAMESPACE "SkyraSettings"

USkyraSettingValueDiscrete_Resolution::USkyraSettingValueDiscrete_Resolution()
{
}

void USkyraSettingValueDiscrete_Resolution::OnInitialized()
{
	Super::OnInitialized();
...
void USkyraSettingValueDiscrete_Resolution::StoreInitial()
{
	// Ignored
}

void USkyraSettingValueDiscrete_Resolution::ResetToDefault()
{
	// Ignored
}

void USkyraSettingValueDiscrete_Resolution::RestoreToInitial()
{
	// Ignored
}

void USkyraSettingValueDiscrete_Resolution::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 USkyraSettingValueDiscrete_Resolution::GetDiscreteOptionIndex() const
{
...
TArray<FText> USkyraSettingValueDiscrete_Resolution::GetDiscreteOptions() const
{
...
void USkyraSettingValueDiscrete_Resolution::OnDependencyChanged()
{
...
void USkyraSettingValueDiscrete_Resolution::InitializeResolutions()
{
	Resolutions.Empty();
...
void USkyraSettingValueDiscrete_Resolution::SelectAppropriateResolutions()
{
...
bool USkyraSettingValueDiscrete_Resolution::ShouldAllowFullScreenResolution(const FScreenResolutionRHI& SrcScreenRes, int32 FilterThreshold) const
{
...
int32 USkyraSettingValueDiscrete_Resolution::FindIndexOfDisplayResolution(const FIntPoint& InPoint) const
{
...
int32 USkyraSettingValueDiscrete_Resolution::FindIndexOfDisplayResolutionForceValid(const FIntPoint& InPoint) const
{
...
int32 USkyraSettingValueDiscrete_Resolution::FindClosestResolutionIndex(const FIntPoint& Resolution) const
{	
	int32 Index = 0;
...
void USkyraSettingValueDiscrete_Resolution::GetStandardWindowResolutions(const FIntPoint& MinResolution, const FIntPoint& MaxResolution, float MinAspectRatio, TArray<FIntPoint>& OutResolutions)
{
...
FText USkyraSettingValueDiscrete_Resolution::FScreenResolutionEntry::GetDisplayText() const
{
