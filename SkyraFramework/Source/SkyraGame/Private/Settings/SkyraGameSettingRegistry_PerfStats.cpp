...
#include "CustomSettings/SkyraSettingValueDiscrete_PerfStat.h"
...
void USkyraGameSettingRegistry::AddPerformanceStatPage(UGameSettingCollection* PerfStatsOuterCategory, USkyraLocalPlayer* InLocalPlayer)
{
	//----------------------------------------------------------------------------------
	{
		static_assert((int32)ESkyraDisplayablePerformanceStat::Count == 15, "Consider updating this function to deal with new performance stats");
		...
		////////////////////////////////////////////////////////////////////////////////////
		{
			...
			//----------------------------------------------------------------------------------
			{
				USkyraSettingValueDiscrete_PerfStat* Setting = NewObject<USkyraSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ESkyraDisplayablePerformanceStat::ClientFPS);
			...
			{
				USkyraSettingValueDiscrete_PerfStat* Setting = NewObject<USkyraSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ESkyraDisplayablePerformanceStat::ServerFPS);
			...
			{
				USkyraSettingValueDiscrete_PerfStat* Setting = NewObject<USkyraSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ESkyraDisplayablePerformanceStat::FrameTime);
			...
			{
				USkyraSettingValueDiscrete_PerfStat* Setting = NewObject<USkyraSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ESkyraDisplayablePerformanceStat::IdleTime);
			...
			{
				USkyraSettingValueDiscrete_PerfStat* Setting = NewObject<USkyraSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ESkyraDisplayablePerformanceStat::FrameTime_GameThread);
			...
			{
				USkyraSettingValueDiscrete_PerfStat* Setting = NewObject<USkyraSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ESkyraDisplayablePerformanceStat::FrameTime_RenderThread);
			...
			{
				USkyraSettingValueDiscrete_PerfStat* Setting = NewObject<USkyraSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ESkyraDisplayablePerformanceStat::FrameTime_RHIThread);
			...
			{
				USkyraSettingValueDiscrete_PerfStat* Setting = NewObject<USkyraSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ESkyraDisplayablePerformanceStat::FrameTime_GPU);
		...
		////////////////////////////////////////////////////////////////////////////////////
		{
			...
			{
				USkyraSettingValueDiscrete_PerfStat* Setting = NewObject<USkyraSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ESkyraDisplayablePerformanceStat::Ping);
			...
			{
				USkyraSettingValueDiscrete_PerfStat* Setting = NewObject<USkyraSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ESkyraDisplayablePerformanceStat::PacketLoss_Incoming);
			...
			{
				USkyraSettingValueDiscrete_PerfStat* Setting = NewObject<USkyraSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ESkyraDisplayablePerformanceStat::PacketLoss_Outgoing);
			...
			{
				USkyraSettingValueDiscrete_PerfStat* Setting = NewObject<USkyraSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ESkyraDisplayablePerformanceStat::PacketRate_Incoming);
			...
			{
				USkyraSettingValueDiscrete_PerfStat* Setting = NewObject<USkyraSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ESkyraDisplayablePerformanceStat::PacketRate_Outgoing);
			...
			{
				USkyraSettingValueDiscrete_PerfStat* Setting = NewObject<USkyraSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ESkyraDisplayablePerformanceStat::PacketSize_Incoming);
			...
			{
				USkyraSettingValueDiscrete_PerfStat* Setting = NewObject<USkyraSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ESkyraDisplayablePerformanceStat::PacketSize_Outgoing);
