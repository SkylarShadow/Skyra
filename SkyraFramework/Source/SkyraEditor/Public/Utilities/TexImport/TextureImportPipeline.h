...
#include "TextureImportPipeline.generated.h"
...
class SKYRAEDITOR_API UTextureImportPipeline : public UInterchangePipelineBase
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Textures")
	TArray<FInterchangeTexture> InterchangeTextures;
...
protected:
	UInterchangeTextureFactoryNode* HandleCreationOfTextureFactoryNode(const UInterchangeTextureNode* TextureNode,const FString& ContentPath);
