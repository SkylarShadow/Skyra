...
#include "SkyraEditorEngine.generated.h"
...
UCLASS()
class USkyraEditorEngine : public UUnrealEdEngine
{
	GENERATED_BODY()

public:

	USkyraEditorEngine(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
